...
class ExploreDataset():
    ...
    def evaluate_reference_dataset(self):
        ...
        counts=reference_dataset[self.variable.is_bycycle].value_counts()
        count_percentage=reference_dataset[self.variable.is_bycycle].value_counts(normalize=True).mul(100)
    ...
    def get_good_bad_annotators(self,project_data,reference_data):
        ...
        for row in combined_dataset.iterrows():
            reference_response=row[1][self.variable.is_bycycle]
            bad_annotations=[]
            good_annotations=[]
    ...
    def get_final_dataset(self,good_annotators_count,bad_annotators_count,reference_dataset,project_dataset):
        ...
        print(good_annotators_data)
        print(bad_annotators_data)
